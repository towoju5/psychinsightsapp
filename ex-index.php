	...
	<main class="mx-8 md:mx-32 min-h-[90vh] lg:mx-48 lg:flex justify-between items-center gap-10 mt-4">
		...
		<div class="w-full lg:w-1/2 justify-center md:order-2 py-16 md:py-6">
			<div class="home__right animee__ group">
				<img src="static/images/phones/iPhone-14-Pro-Space-Black-1x.png" alt="mockup for an iphone phone" class="home__image home__image--1 fly_in w-1/2">
...
<section id="ball-section" class="bg-white shadow-lg">
	<div class="grid md:grid-cols-2 px-[4rem] py-[3rem] gap-10 items-center">
			...
			<ul class="space-y-8">
				<li class="flex items-start gap-10">
					...
					<div class="group">
						...
						<p class="reviews__text text-left">Get started with a stress-free 7-day trial of our premium
							mental health resources without any need for credit card details—because we believe in easy
							access to peace of mind.</p>
					</div>
				</li>
				<li class="flex items-start gap-10">
					...
					<div class="group">
						...
						<p class="reviews__text font-light text-left">Our personalized assessments guide you to discover
							mental health resources that cater specifically to your needs from the moment you join.</p>
					</div>
				</li>
				<li class="flex items-start gap-10">
					...
					<div class="group">
						...
						<p class="reviews__text text-left">Our customer support team is available 24/7 to ensure you
							have the help you need, whenever you need it. Day or night, we're just a message away.</p>
					</div>
				</li>
			</ul>
		</div>
	...
	<div class="stories">
		<div class="stories__inner">
			...
			<div class="carousel py-3 glide">
				<div class="glide px-16 py-8 space-y-8">
					<div class="glide__track" data-glide-el="track">
						<ul class="glide__slides flex items-center gap-4">
							<li class="glide__slide">
								<div class="reviews js-reviews" data-te-carousel-active data-te-carousel-item style="backface-visibility: hidden">
					...
					<div class="glide__arrows flex justify-end gap-8" data-glide-el="controls">
