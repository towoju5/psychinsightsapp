...
<section class="terms">
  <div class="terms__inner">
    <div class="terms__row">
      <h3 class="terms__head">Terms of Service</h3>
    </div>
    <div class="terms__row">
      <div class="items-center flex flex-col">
        <div class="text-black text-2xl font-bold uppercase whitespace-nowrap">About Us</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">Welcome to Psych Insights, your dedicated ally in navigating life's complex intricacies.
          Here, we believe that your path to well-being should be as unique and individual as you
          are. Our mission is to stand beside you, offering an unparalleled blend of tailored
          resources, ensuring that you are never navigating life's intricate challenges alone.
          Embark on a transformative journey with us, a journey that harmoniously combines the
          profound insights from industry experts with a deep understanding of your personal
          needs. At Psych Insights, we commit ourselves to fostering a nurturing environment that
          prioritizes your mental well-being and holistic self-improvement.
          From the moment you join our community, you will experience a curated pathway
          designed exclusively for you, illuminating your road to a more balanced, brighter
          tomorrow.
        </div>
        <div class="text-black text-2xl font-bold uppercase mt-5">Terms & Conditions</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">By accessing or using any of the web services, mobile app or any other official electronic
          media adopted Psych Insights in dispensing its services, you agree to comply with and be
          bound by these Terms and Conditions of Use (&quot;Terms & Conditions&quot;). Please read these
        ...
        <div class="text-black text-2xl font-bold uppercase mt-5">Intellectual Property</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">All content hosted on our website, including but not limited to text, graphics, logos, and
        ...
        <div class="text-black text-2xl font-bold uppercase mt-5">Registration and Use</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">In order to gain access to the use of the Psych Insights platform via web or mobile app,
          you are required to register and provide necessary details which will be unique to your
        ...
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">Once your registration is complete, you will be asked to respond to a series of fourteen
          onboarding questions. These questions are designed to help us gauge your current
          mental wellbeing and identify your specific needs. Your honest and considered responses
        ...
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">The DASS-21 questionnaire is a valid psychological screening tool to assess stress,
          depression and anxiety levels, will be made available to our premium users. Premium
          users will be able to complete this questionnaire on a weekly basis to capture fluctuations
          in their psychological profile over time, and thus personalised resources can be adjusted
          accordingly. These results will assist in curating the contents that will be shared with you
          via the web or mobile app.
        </div>
        <div class="text-black text-2xl font-bold uppercase mt-5">K-10 Questionnaire</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">As a basic user, you will be provided with access to the K10 questionnaire, which is an
          established psychological assessment tool, in addition to 4 additional questions to
          capture aspects of your lifestyle. These results will assist in curating your personalized
          resources.</div>
        <div class="text-black text-2xl font-bold uppercase mt-5">Trial Period</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full">Once your registration is complete, you will be provided with a 7-day trial of the Premium
          Version of Psych Insights. After this period, you will be able to subscribe in order to
          continue to enjoy the full package offered by the company.</div>
        ...
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full"><span class="">
            ...
            content, purpose, policies or practices. You will not engage in solicitation activities on our
          ...
          <ul>
            ...
            <li>the use of the Platform or Therapist Services (collectively, &quot;Disputes&quot;) will
              be resolved on an individual basis by final and binding arbitration,
              regardless of its date of accrual. Except as it otherwise provides, this
              Arbitration Agreement is intended to apply to the resolution of Disputes
              that otherwise would be resolved in a court of law or before a forum other
              than arbitration. All claims in arbitration are subject to the same statutes
              of limitation that would apply in court. By accepting the terms of this
              Arbitration Agreement, you and the Company mutually agree to waive
              their respective rights to trial by jury.
              The Parties recognize that the Agreement involves transactions spanning across state
              boundaries and agree that all matters pertaining to arbitration or the enforce-ability of
              this Arbitration Agreement shall be governed by the Commercial Arbitration Act
              applicable in the relevant Australian jurisdiction. The arbitration shall be facilitated by
              the Australian Centre for International Commercial Arbitration (&quot;ACICA&quot;) under its
              Commercial Arbitration Rules (&quot;ACICA Arbitration Rules&quot;), which are accessible online at
              www.acica.org.au or by utilizing a service such as Google to search for &quot;ACICA
              Commercial Arbitration Rules&quot;. Nevertheless, in the event of a discrepancy between the
              ACICA Arbitration Rules and this Arbitration Agreement, the stipulations outlined in this
              Arbitration Agreement shall prevail. The following terms and procedures shall apply:
            </li>
            <li>The arbitration shall be heard by one arbitrator selected in accordance
              with the ACICA Arbitration Rules. The arbitrator shall be a member of the
              bar of the state in which the arbitration will be conducted or a retired judge
              from any jurisdiction and, in either case, shall have experience in the law
              underlying the dispute.

            </li>
            <li>Other than issues related to the Class Action Waiver (as defined below), the
              ...
              interpretation, applicability, enforce-ability or formation of this Arbitration
              Agreement, any part of it, or of the Agreement including, but not limited to,
              any claim that all or any part of this Arbitration Agreement or Agreement
              is void or voidable.
            </li>
            <li>If the parties cannot otherwise agree on a location for the arbitration, the
              arbitration shall take place in Canberra, Australia.
            </li>
            <li>Each party will pay the fees for its own attorneys, subject to any remedies
              to which that party may later be entitled under applicable law. In all cases
              where required by law, the Company will pay the arbitrator's and
              arbitration fees. If under applicable law the Company is not required to pay
              all of the arbitrator's and/or arbitration fees, such fee(s) will be
              apportioned between the Parties in accordance with said applicable law.
              Any disputes regarding whether the Company is required to pay the
              arbitrator’s and arbitration fees and/or how those fees are to be
              apportioned between the Parties will be resolved by the arbitrator.
            </li>
            <li>The arbitrator shall issue orders (including subpoenas to third parties for
              pre-hearing discovery) allowing the parties to conduct discovery sufficient
              to allow each party to prepare its claims and/or defenses, taking into
              consideration that arbitration is designed to be a speedy and efficient
              method for resolving disputes.
            </li>
            <li>Except as provided in the Class Action Waiver (as defined below), the
              arbitrator may award all remedies to which a party is entitled under
            ...
            <li>Either party shall be permitted to file a motion to dismiss and/or motion
              for summary judgment, and the arbitrator will apply the standards of the
              Uniform Civil Procedure Rules 2005 governing such motions.
            </li>
            <li>The arbitrator's decision or award shall be in writing with findings of fact
              and conclusions of law. Judgment may be entered on the arbitrator's
              decision or award in any court of competent jurisdiction.
            </li>
            <li>A party may apply to a court of competent jurisdiction for temporary or
              preliminary injunctive relief in connection with an arbitrable controversy
              in accordance with applicable law, and any such application shall not be
              deemed incompatible with or waiver of this Arbitration Agreement. The
            ...
            representative action to the maximum extent permitted by law, and an arbitrator
            will not have any authority to hear or arbitrate any such class, collective, or other
            representative action. You also waive your right to receive notice of any class,
            collective, or other representative action that may be filed. Notwithstanding any
            other clause contained in this Arbitration Agreement or the ACICA Arbitration
          ...
          <ul>
            <li><span class="">The Parties shall cooperate to group the arbitration demands into
                ...
                there are fewer than 100 arbitration demands left over after the batching
                previously described, a final batch shall consist of the remaining demands.
            </li>
            <li>Claimants’ counsel shall organize and present the batched demands to the
              arbitration provider in a format as directed by the arbitration provider.
            </li>
            <li>The arbitration provider shall treat each batch of demands as one case,
              with each case having one demand for arbitration, one appointed
              arbitrator, and one set of administrative documents, and administrative
              and filing fees per batch.
            </li>
            <li>A separate arbitrator will be appointed to, and administrative and filing
              fees assessed for, each batch of demands.
              </span></li>
          </ul><span class="">The Parties agree that arbitration demands are of a &quot;similar nature&quot; if they arise out of or
            relate to a similar factual scenario and raise the same or similar legal issues and seek the
            same or similar relief. You agree to cooperate in good faith with the Company and the
            arbitration provider to implement such a batch approach to resolution and fees.
          ...
          <ul>
            ...
            <li>individual claims of sexual assault or sexual harassment occurring in
              connection with your use of the Platform; and/or
            </li>
            <li>injunctive or other equitable relief in a court of competent jurisdiction to
              ...
              other intellectual property rights. </span></li>
          </ul><span class="">Also, this Arbitration Agreement does
            not apply to disputes that may not be subject to arbitration as expressly
            provided by a controlling federal or state statute. Disputes between the
            parties that may not be subject to a pre-dispute arbitration agreement, as
            provided by the Australian Securities and Investments Commission Act of
            2001, or any other relevant provisions established under Australian law,
            are excluded from the coverage of this Arbitration Agreement. This
          ...
          <ul>
            ...
            <li>describe the nature and basis of the dispute, claim, or controversy; and
            </li>
            <li>set forth the specific relief sought. </span></li>
          </ul><span class="">The Company will send its Notice of
            Dispute to your billing or email address. You will send your Notice of
            Dispute to: the company address as contained in the contact us section of
            this web platform. All offers, promises, conduct and statements, whether
            oral or written, made in the course of the negotiation by any of the Parties,
            their agents, employees, and attorneys are confidential, privileged and
            inadmissible for any purpose, including as evidence of liability or for
            ...
            Therapist Services. To the extent that any third-party beneficiary to this
            ...
            period, neither you nor ACICA Arbitration Rules will be required to arbitrate
            disputes and may instead litigate those disputes without regard to this Arbitration
            Agreement and Class Action Waiver. Should you not opt out of this Arbitration
            Agreement and Class Action Waiver within the 30-day period, you and ACICA shall
            ...
            You also give affirmative consent to the provisions set forth in the accompanying Privacy
            ...
            will continue to be accurate, current and complete.
            You agree, confirm and acknowledge that you are responsible for maintaining the
            ...
            You agree, confirm and acknowledge that you are solely and fully liable and responsible
            for all activities performed using your Account Access. You further acknowledge and
            agree that we will hold you liable and responsible for any damage or loss incurred as a
            result of the use of your Account Access by any person whether authorized by you or not,
            and you agree to indemnify us for any such damage or loss.
            You agree and commit not to use the account or Account Access of any other person for
            any reason.
        ...
        <div class="text-black text-2xl font-bold uppercase mt-2.5">Payments</div>
        <div class="text-black text-2xl w-full mt-2.5 max-md:max-w-full"><span class="">You confirm and agree to use only credit cards or other payment means (collectively
            “Payment Means”) which you are duly and fully authorized to use, and that all payment
            ...
            of jurisdiction by the aforementioned courts. Nothing in this Agreement, including the
            ...
            indemnification shall survive the termination or expiration of this Agreement.</span></div>
      </div>
    </div>
  </div>
</section>
