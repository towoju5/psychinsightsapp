	...
	<div class="about__inner">
					...
					<div class="xoxo">
						<div class="ceo__text-group">
							<small class="ceo__small">
								...
								<br>
								We envision a world where seeking psychological support is as natural as taking care of
								one's physical health, and where our application serves as a trusted companion for
		...
		<section class="ourstory">
			...
			<div class="ourstory__row ourstory__row--3">
				<p class="ceo__small">
					Our story is one of passion, empathy, and a commitment to providing the resources and tools needed
					to
					empower
					individuals like you on your path to mental wellness. <br> <br>
					It all started with a simple yet profound realization: mental health is just as important as
					physical
					health.
					In a world that often prioritizes the visible, we recognized the need to create a space where the
					invisible
					struggles could find a voice. Thus, PsychInsight was born. <br> <br>
					At PsychInsight, we understand that the journey to mental wellness is unique for each individual.
					That's why
					we've created a platform that caters to your specific needs, whether you're seeking guidance,
					support, or
					simply looking to enhance your mental well-being. We are here to provide you with the tools and
					resources
					that
					empower you to take control of your mental health journey. <br> <br>
					As we continue to grow and evolve, our dedication to promoting mental wellness remains unwavering.
					Our story
					is your story – a story of resilience, hope, and the belief that with the right insights and tools,
					you can
					achieve the mental well-being you deserve.
				</p>
			</div>
		</section>
