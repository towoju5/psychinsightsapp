<?php require_once('header.php') ?>
		...
		<main class="mx-8 md:mx-32 min-h-[90vh] lg:mx-48 lg:flex justify-between items-center gap-10 mt-4">
			...
			<div class="w-full lg:w-1/2 justify-center md:order-2 py-16 md:py-6">
				<div class="home__right animee__ group">
					<img src="./static/images/index/homescreen.png" alt="mockup for an iphone phone"
						class="home__image home__image--1 fly_in w-1/2">
					<img src="./static/images/phones/group48095554.png" alt="mockup for an iphone phone"
						class="home__image home__image--2 fly_out w-1/2">
				</div>
			</div>
			...
			<div class="lg:w-1/2 md:order-1 md:pb-6">
				<div id="carouselExampleCrossfade" class="relative" data-te-carousel-init data-te-ride="carousel">
					...
					<div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
						<!--First item-->
						<div class="relative float-left -mr-[100%] w-full !transform-none opacity-0 transition-opacity duration-[100ms] ease-in-out motion-reduce:transition-none"
							data-te-carousel-fade data-te-carousel-item data-te-carousel-active>
							<div
								class="home__texts home__texts-empower home__texts-active text-center lg:text-left w-full">
						...
						<!--Second item-->
						<div class="relative float-left -mr-[100%] hidden w-full !transform-none opacity-0 transition-opacity duration-[100ms] ease-in-out motion-reduce:transition-none"
	...
	<section id="ball-section"  class="bg-white shadow-lg">
		<div class="grid md:grid-cols-2 px-[4rem] py-[3rem] gap-10 items-center lg:mx-48">
			<div class="w-2/5 px-3 py-2 w-full">
				<img src="./static/images/index/happy-moment.png" alt="Happy moment" class="mx-auto">
			</div>
			<div class="w-2/5 px-3 py-2 text-left w-full">
						...
						<div class="glide__slides" style="overflow: none!important;">
							<div class="reviews js-reviews glide__slide">
								<div class="reviews__svg-container">
									<svg class="reviews__svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
										viewBox="0 0 24 24">
										<path fill="#207384"
				...
				<div class="text-center my-6 md:mx-16 lg:mx-32  mt-10 ">
					<div class="grid md:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-10">
						<div class="text-center mx-auto">
							...
							<img src="static/images/humaan-stoic.png" alt="this is a humaan stoic file"
								class="humaans__image mx-auto">
						...
						<div class="grid-2 text-center mx-auto">
							...
							<img src="static/images/humaan-meditation.png" alt="meditation posture"
								class="humaans__image mx-auto">
	...
	<section id="categories-section" class="categories lg:mb-32">
		<div class="categories__inner">
			<div class="mx-4 mb-4 py-3">
				<ul class="flex flex-wrap justify-center gap-6 -mb-px text-sm font-medium text-center text-gray-500"
					id="tabs-example" role="tablist">
					<li class="mr-2" role="presentation">
						<button class="bg-[#EFC49D] md:text-xl lg:text-2xl text-black rounded-xl px-10 py-1"
							id="profile-tab-Depression" type="button" role="tab" aria-controls="dashboard-Depression"
							aria-selected="false">Depression</button>
					</li>
					<li class="mr-2" role="presentation">
						<button class="bg-[#EFC49D] md:text-xl lg:text-2xl text-black rounded-xl px-10 py-1"
							id="dashboard-tab-Anxiety" type="button" role="tab" aria-controls="dashboard-Anxiety"
							aria-selected="false">Anxiety</button>
					</li>
					<li class="mr-2" role="presentation">
						<button class="bg-[#EFC49D] md:text-xl lg:text-2xl text-black rounded-xl px-10 py-1"
							id="settings-tab-Stress" type="button" role="tab" aria-controls="settings-Stress"
							aria-selected="false">Stress</button>
					</li>
					<li role="presentation">
						<button class="bg-[#EFC49D] md:text-xl lg:text-2xl text-black rounded-xl px-10 py-1"
							id="contacts-tab-Sleep" type="button" role="tab" aria-controls="contacts-Sleep"
							aria-selected="false">Sleep</button>
					</li>
					<li class="mr-2" role="presentation">
						<button class="bg-[#EFC49D] md:text-xl lg:text-2xl text-black rounded-xl px-10 py-1"
							id="settings-tab-Motivation" type="button" role="tab" aria-controls="settings-Motivation"
							aria-selected="false">Motivation</button>
					</li>
					<li role="presentation">
						<button class="bg-[#EFC49D] md:text-xl lg:text-2xl text-black rounded-xl px-10 py-1"
							id="contacts-tab-Concentration" type="button" role="tab"
							aria-controls="contacts-Concentration" aria-selected="false">Concentration</button>
					</li>
				</ul>
			</div>
			<div id="tabContentExample">
				<div class="rounded-lg bg-gray-50 lg:gap-10" id="dashboard-Depression" role="tabpanel"
					aria-labelledby="profile-tab-Depression">
					<div class="flex w-full items-center gap-10 mx-4">
						...
						<div class="w-full md:w-3/5 py-[4rem] rounded-lg px-8 bg-white shadow border border-gray-200">
							...
							<div
								class="mx-[3rem] py-4 px-10 md:px-[3rem] lg:px-32 bg-[#A6C1ED] rounded-xl flex items-center gap-10 lg:gap-20">
								<div class="play-btn">
				...
				<div class="hidden p-4 rounded-lg bg-gray-50" id="dashboard-Anxiety" role="tabpanel"
					aria-labelledby="dashboard-tab-Anxiety">
					<div class="flex w-full items-center gap-10">
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/iPhone 15 Pro Portrait Mockup.png" alt="sleep_001s"
								class="mx-auto">
						</div>
						<div class="w-full md:w-3/5 py-[4rem] rounded-lg px-8 bg-white shadow"
							style="background-image: url('./static/images/video-card-bg.png');">
							<p class="catty_text mb-6">Learn to manage feelings and thoughts with the lifelong skill of
								everyday mindfulness, any time of the day.</p>
							<div
								class="mx-[3rem] py-4 px-10 md:px-[3rem] lg:px-32 bg-[#A6C1ED] rounded-xl flex items-center gap-10 lg:gap-20">
						...
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/right-anxiety-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
					</div>
				</div>
				<div class="hidden p-4 rounded-lg bg-gray-50" id="settings-Stress" role="tabpanel"
					aria-labelledby="settings-tab-Stress">
					<div class="flex w-full items-center gap-10">
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/left-stress-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
						<div class="w-full md:w-3/5 py-[4rem] rounded-lg px-8 bg-white shadow border border-gray-200">
							<p class="catty_text mb-6">Learn to manage feelings and thoughts with the lifelong skill of
						...
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/right-stress-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
					</div>
				</div>
				<div class="hidden p-4 rounded-lg bg-gray-50" id="contacts-Sleep" role="tabpanel"
					aria-labelledby="contacts-tab-Sleep">
					<div class="flex w-full items-center gap-10">
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/left-sleep-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
						<div class="w-full md:w-3/5 py-[4rem] rounded-lg px-8 bg-white shadow border border-gray-200">
							<p class="catty_text mb-6">Learn to manage feelings and thoughts with the lifelong skill of
						...
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/right-sleep-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
					</div>
				</div>
				<div class="hidden p-4 rounded-lg bg-gray-50" id="settings-Motivation" role="tabpanel"
					aria-labelledby="settings-tab-Motivation">
					<div class="flex w-full items-center gap-10">
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/iPhone 15 Pro Portrait Mockup.png" alt="sleep_001s"
								class="mx-auto">
				...
				<div class="hidden p-4 rounded-lg bg-gray-50" id="contacts-Concentration" role="tabpanel"
					aria-labelledby="contacts-tab-Concentration">
					<div class="flex w-full items-center gap-10">
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/left-concentration-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
						<div class="w-full md:w-3/5 py-[4rem] rounded-lg px-8 bg-white shadow border border-gray-200">
							<p class="catty_text mb-6">Learn to manage feelings and thoughts with the lifelong skill of
						...
						<div class="w-1/5 hidden md:block">
							<img src="./static/images/phones/right-concentration-phone-0.9x.png" alt="sleep_001s"
								class="mx-auto">
						</div>
					</div>
				</div>
				...
				<div class="gap-4">
					...
					<div class="md:flex md:justify-between w-full">
						<div class="bg-white rounded-lg p-4 shadow-md w-full md:1/2 lg:w-8/12">
							<div class="articles__div-col articles__div-col--1"
								style="background-image: url('./static/images/blog/blog-001.png');">
								...
								<a href="blog" class="articles__link">
									...
									<img src="static/images/chevron-right.svg" alt="chevron pointing right"
										class="articles__chevron">
								</a>
							</div>
						</div>
						...
						<div class="bg-white rounded-lg p-4 shadow-md w-full md:1/2 lg:w-4/12">
							<div class="articles__div-col articles__div-col--1"
								style="background-image: url('./static/images/blog/blog-002.png');">
					...
					<div class="md:flex md:justify-between w-full">
						...
						<div class="bg-white rounded-lg p-4 shadow-md w-full md:1/2 lg:w-4/12">
							<div class="articles__div-col articles__div-col--1"
								style="background-image: url('./static/images/blog/blog-003.png');">
						...
						<div class="bg-white rounded-lg p-4 shadow-md w-full md:1/2 lg:w-8/12">
							<div class="articles__div-col articles__div-col--1"
								style="background-image: url('./static/images/blog/blog-004.png');">
					...
					<div class="md:flex md:justify-between w-full">
						...
						<div class="bg-white rounded-lg p-4 shadow-md w-full md:1/2 lg:w-8/12">
							<div class="articles__div-col articles__div-col--1"
								style="background-image: url('./static/images/blog/blog-005.png');">
						...
						<div class="bg-white rounded-lg p-4 shadow-md w-full md:1/2 lg:w-4/12">
							<div class="articles__div-col articles__div-col--1"
								style="background-image: url('./static/images/blog/blog-006.png');">
